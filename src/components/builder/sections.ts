...
export const WIZARD_SECTIONS: WizardSectionDef[] = [
  {
    ...
    termKeys: ['nav.families', 'entity.family', 'entity.familyOf', 'entity.member', 'entity.members', 'entity.cred'],
  },
  {
    id: 'courses',
    title: 'חוגים',
    emoji: '🎨',
    module: 'courses',
    termKeys: ['nav.courses', 'entity.course', 'entity.teacher', 'entity.enrollment', 'entity.enrollments', 'entity.student', 'entity.students'],
  },
  { id: 'calendar', title: 'לוח שנה', emoji: '📅', module: 'calendar', termKeys: ['nav.calendar'] },
  { id: 'diary', title: 'יומן חדרים', emoji: '📖', module: 'diary', termKeys: ['nav.diary', 'entity.room', 'entity.rooms'] },
  {
    id: 'supporters',
    title: 'תורמים',
    emoji: '💛',
  ...
  { id: 'shop7', title: 'חלוקה', emoji: '🚚', module: 'shop7', termKeys: ['nav.shop7', 'entity.volunteer', 'entity.volunteers', 'entity.delivery'] },
  ...
  { id: 'signup', title: 'מסך ההרשמה', emoji: '🪐', termKeys: [] },
];
...
export function featureModuleKey(m: FeatureDef['module']): ModuleKey | null {
  return m === 'home' || m === 'settings' || m === 'core' || m === 'shell' || m === 'signup' ? null : m;
}
