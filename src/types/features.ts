...
export const FEATURES: FeatureDef[] = [
  ...
  { key: 'supporters.segula', label: 'סגולת 40 יום', desc: 'כפתור "🕯 40 ימים" בכרטיס קשר-הבא — זריעת תזכורות-לוח מדורגות לזיווג (יום 1/7/21/35/40) מהיום, מחושב לבד', module: 'supporters' },
