...
## נותר (roadmap · מוגדר-היקף · אושר "הכל בלולאה")
- **היקום 3D + מכונת-זמן חיה** — הרחבת הגלקסיה למבט-תלת-ממד + סרגל-זמן שמריץ את מכונת-הזמן.
- **מיגרציית-דרגות אמיתית** — דורש שמירת-מצב-היסטורי (כרגע פרוקסי-מגמה); שינוי-סכמה additive.
- **עוד עומק-נתונים** — מנועי-אנליטיקה נוספים (Pareto/ריכוזיות · פילוח-מתקדם).
