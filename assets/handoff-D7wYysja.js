...
</body></html>`}function k(e,n,r=`text/html`){if(!t())return;let i=document.createElement(`a`);i.href=URL.createObjectURL(new Blob([n],{type:`${r};charset=utf-8`})),i.download=e,i.click(),setTimeout(()=>URL.revokeObjectURL(i.href),5e3)}export{k as a,u as c,m as d,O as i,p as l,v as n,b as o,g as r,c as s,_ as t,d as u};