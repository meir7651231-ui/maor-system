...
for (const [, name] of REPOS) for (const x of ['tokens', 'flags', 'terms', 'engines', 'actions', 'strings', 'components', 'verticals', 'knowledge', 'functions']) { try { run(`./extract/${x}.mjs`, [name]); } catch {} }
run('./reconcile.mjs', []);
